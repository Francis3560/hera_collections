    ...
    <div className="p-6 max-w-[1400px] mx-auto space-y-12 animate-fade-in pb-24">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pt-6">
        <div className="space-y-4">
          <Badge variant="outline" className="px-5 py-2 border-primary/20 bg-primary/5 text-primary text-[10px] font-bold tracking-wider rounded-full">
        ...
        <div className="hidden lg:flex items-center gap-2 text-muted-foreground">
           ...
           <p className="text-[10px] font-bold tracking-wider max-w-[120px] leading-tight">Secure Multi-User Counting Enabled</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
           ...
           {!activeAudit ? (
             ...
             >
                ...
                <div className="relative z-10 space-y-3">
                   <h3 className="text-3xl font-bold">No Active Stream detected</h3>
                ...
                <Button 
                   ...
                   className="relative z-10 btn-primary h-16 px-12 rounded-2xl text-lg font-bold shadow-elegant group"
                >
                   Go to Session Vault
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-b border-white/10 pb-10 mb-10">
                   <div className="space-y-4">
                      <div className="flex items-center gap-4">
                         <Badge className="bg-blue-500 text-white font-bold px-4 h-7 text-[10px] animate-pulse rounded-lg border-none">LIVE NOW</Badge>
                         <h4 className="text-3xl font-bold">{activeAudit.title}</h4>
                      </div>
                      <div className="flex flex-wrap items-center gap-4 text-xs font-bold text-muted-foreground tracking-wider">
                   ...
                   <div className="flex flex-col items-end">
                      <span className="text-5xl font-bold text-primary">{( (activeAudit.itemsCounted / (activeAudit.totalItems || 1)) * 100).toFixed(0)}%</span>
                      <span className="text-[10px] font-bold text-muted-foreground tracking-wider opacity-60">Session Progress</span>
                   </div>
                </div>
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6">
                   <div className="p-8 rounded-[2rem] bg-black/40 border border-white/5 group-hover:border-primary/20 transition-all flex flex-col gap-4">
                      ...
                      <div className="space-y-1">
                         <h5 className="font-bold text-xl leading-none">Counting Portal</h5>
                      ...
                      <Button 
                         ...
                         className="w-full h-14 rounded-2xl btn-primary font-bold text-sm tracking-wider mt-2 group shadow-elegant"
                      >
                         Launch Terminal
                   ...
                   <div className="p-8 rounded-[2rem] bg-black/40 border border-white/5 opacity-50 relative overflow-hidden flex flex-col justify-center items-center text-center gap-4">
                      ...
                      <div className="space-y-1">
                         <h5 className="font-bold text-xl text-muted-foreground">Rapid Scanner</h5>
                         <p className="text-[10px] text-muted-foreground font-medium tracking-wider">Waiting for stream...</p>
                      </div>
                      <Badge variant="outline" className="text-[8px] border-white/20 font-bold tracking-wider h-6 px-4 rounded-full">DETECTING PERIPHERALS</Badge>
                   </div>
                </div>
             </motion.div>
           )}
        ...
        <div className="space-y-6">
           <Card className="glass-card border-none shadow-soft p-8 rounded-[2rem] bg-white/5 backdrop-blur-3xl space-y-8 border border-white/5">
              <h3 className="text-sm font-bold tracking-widest text-muted-foreground opacity-50 uppercase">Audit Protocol</h3>
           ...
           <div className="p-8 rounded-[2rem] bg-gradient-to-br from-primary/20 to-transparent border border-primary/20 flex flex-col gap-4 group cursor-help">
              ...
              <h4 className="text-xl font-bold leading-none">Need assistance?</h4>
              <p className="text-sm font-medium text-muted-foreground leading-relaxed tracking-wide opacity-60">
