    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-300">
      ...
      <main className="flex-1 overflow-x-hidden">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-6 max-w-4xl prose prose-sm sm:prose-base dark:prose-invert prose-headings:font-bold prose-headings:tracking-tight prose-a:text-primary hover:prose-a:text-primary-accent">
            <p className="lead text-lg text-muted-foreground mb-8">
               Shipping & deliveries are done through an external third party courier service. Once the items are dispatched for delivery, the courier takes full responsibility for timely delivery and the business will not be held liable. The business will however provide any assistance necessary to remedy the situation.
            </p>
          </div>
        </section>
      </main>
