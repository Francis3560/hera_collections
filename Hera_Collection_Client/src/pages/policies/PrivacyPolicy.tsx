      ...
      <main className="flex-1 overflow-x-hidden">
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-6 max-w-4xl prose prose-sm sm:prose-base dark:prose-invert prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-primary prose-a:text-primary hover:prose-a:text-primary-accent">
            <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from heracollections.com (the “Site”).</p>

            <h3 className="text-primary">Personal information we collect</h3>
            ...
            <h3 className="text-primary">How do we use your personal information?</h3>
            ...
            <h3 className="text-primary">Sharing your personal Information</h3>
            ...
            <h3 className="text-primary">Changes</h3>
            <p>We may update this privacy policy from time to time in order to reflect, for example, changes to our practices or for other operational, legal or regulatory reasons.</p>

            <h3 className="text-primary">Minors</h3>
            <p>The Site is not intended for individuals under the age of 16.</p>

            <h3 className="text-primary">Contact us</h3>
            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at <a href="mailto:admin@heracollections.com">admin@heracollections.com</a> or by mail using the details provided below:</p>

            <p>
              Hera Collections<br/>
              [Re: Privacy Compliance Officer]<br/>
              Hera Collections, Nairobi, Nairobi, Nairobi, 00200, Kenya
            </p>
          </div>
        </section>
      </main>
